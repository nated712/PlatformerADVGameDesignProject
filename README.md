...
The gameplay is based around defeating enemies for fuel while making it to the end of the level in the shortest time possible.
You get graded based on your time to beat the level and can get bonus time rewards based on what you do throughout the level.
